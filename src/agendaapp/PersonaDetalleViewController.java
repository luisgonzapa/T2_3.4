...
public class PersonaDetalleViewController implements Initializable {
    ...
    //Instancia un AnchorPane de dicha vista/ventana.
    @FXML
    ...
    //Guardará los datos introducidos en la base de datos
    @FXML
    private void onActionButtonGuardar(ActionEvent event) {
        ...
        if (!errorFormato) 
        {
            try 
            {
                //Controla que el campo no sea nulo o esté vacío
                ...
                {
                    //Muestra alerta si es nulo o vacío.
                    errorFormato = true;
                    Alert alert = new Alert(AlertType.INFORMATION, "Nombre no valido");
                    alert.showAndWait();
                }

                //Control errores de apellidos.
                ...
                //Controla la insercción de la columna salario.
                if ((TextFielNumHijos).getText() != null && !TextFielSalario.getText().isEmpty()) 
                {
                    try 
                    {
                ...
                //Introduce dependiendo del checkbox seleccionado.
                ...
                {
                    Alert alert = new Alert(AlertType.INFORMATION, "Seleccione una provincia");
                    alert.showAndWait();
                    errorFormato = true;
                }
                ...
                if (!errorFormato) 
                {
                    ...
                    //Guarda en la posición siguiente, 
                    TablePosition pos = new TablePosition(tableViewPrevio, numFilaSeleccionada, null);
                    tableViewPrevio.getFocusModel().focus(pos);
                    tableViewPrevio.requestFocus();

                    //Agrega la ventana rootPersonaDetalleView y la muestra.
                ...
                //Si los datos introducidos no concuerdan con los formatos de la BD, ocurre dicha excepción.
                //Que hará un rollback del último commit.
    ...
    /*
    Si se presiona el botón cancelar, se realizará un rollback del último commit, cerrará la ventana
    y volverá a cargar la vista de rootAgendaView.
    */
    @FXML
    ...
    //Muestra los datos almacenado en dicho objeto persona, y con los getters, recoje los datos.
